 ...
 * Uses DeepSeek API for SMART comprehension questions
 */
...
`;
    ...
    try {
      ...
      if (!jsonMatch) {
        throw new Error('Could not parse quiz JSON from LLM response');
      }
...
module.exports = LLMQuizGenerator;
